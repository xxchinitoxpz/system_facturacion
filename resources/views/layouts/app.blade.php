...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-100">
        <div class="min-h-screen flex" x-data="{ 
            ...
            reportsOpen: {{ request()->routeIs('reports.*') ? 'true' : 'false' }}
        }">
            <!-- Overlay para móvil -->
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="{{ route('comprobantes.index') }}"
                                   class="flex items-center gap-3 px-4 py-3 rounded-lg transition font-medium {{ request()->routeIs('comprobantes.*') ? 'bg-indigo-700 shadow text-white' : 'hover:bg-indigo-700' }}">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <button @click="reportsOpen = !reportsOpen"
                                        class="flex items-center justify-between w-full px-4 py-3 rounded-lg hover:bg-indigo-700 transition font-medium {{ request()->routeIs('reports.*') ? 'bg-indigo-700 shadow text-white' : '' }}">
                                ...
                                <div x-show="reportsOpen" x-transition class="ml-4 mt-2 space-y-1">
                                    <a href="{{ route('reports.sales') }}"
                                       class="flex items-center gap-3 px-4 py-2 rounded-lg transition font-medium text-sm {{ request()->routeIs('reports.sales') ? 'bg-indigo-600 text-white' : 'hover:bg-indigo-700' }}">
