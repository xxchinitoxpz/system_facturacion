<x-app-layout>
    <div class="max-w-full mx-auto bg-white rounded-xl shadow p-4 mt-8">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-indigo-800">Registrar Producto Defectuoso</h1>
        ...
        <form id="createDefectiveProductForm" method="POST" action="{{ route('defective-products.store') }}" class="space-y-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        >
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" {{ old('producto_id') == $product->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="deshechado" {{ old('estado') == 'deshechado' ? 'selected' : '' }}>Deshechado</option>
                        </select>
                        @error('estado')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="submit" id="submitBtn" class="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors flex items-center gap-2">
                    <span id="submitText">Registrar Producto Defectuoso</span>
    ...
    <script>
        ...
        document.getElementById('createDefectiveProductForm').addEventListener('submit', function(e) {
