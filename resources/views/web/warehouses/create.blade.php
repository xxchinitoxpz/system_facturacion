<x-app-layout>
    <div class="max-w-full mx-auto bg-white rounded-xl shadow p-4 mt-8">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-indigo-800">Crear Almacén</h1>
        ...
        <form id="createWarehouseForm" action="{{ route('warehouses.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-indigo-50 rounded-lg p-6">
                ...
                <div class="mt-6">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="3"
                              ...
                              placeholder="Descripción del almacén (opcional)">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex gap-3 pt-6 border-t border-gray-200 justify-end">
                ...
                <button type="submit" id="submitBtn" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-2">
                    <span id="submitText">Crear Almacén</span>
